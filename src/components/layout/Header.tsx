...
import { getAllArticles, type Country, type Continent } from "@/data/destinations";
...
const Header = () => {
  ...
  const allArticles = useMemo(() => getAllArticles(continents), [continents]);
  ...
  }, [searchQuery, allArticles, continents]);
