...
const CountryPage = () => {
  ...
  const { continents, isLoading } = useDestinations();
  const continent = getContinentBySlug(continents, continentSlug || "");
  const country = getCountryBySlug(continents, continentSlug || "", countrySlug || "");
